        ...
        <header className="fixed top-0 z-50 w-full border-b border-border-light bg-white/90 backdrop-blur-md">
            <div className="flex items-center justify-between px-6 py-4 lg:px-12 max-w-[1440px] mx-auto">
                ...
                <div className="flex items-center gap-3 text-text-main group cursor-pointer">
                    ...
                    <h2 className="text-xl font-bold tracking-tight text-slate-900">ADHTECH</h2>
                </div>
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <a className="text-sm font-medium text-text-secondary hover:text-primary transition-colors" href="#">Projects</a>
                    <a className="text-sm font-medium text-text-secondary hover:text-primary transition-colors" href="#">Contact</a>
                </div>
